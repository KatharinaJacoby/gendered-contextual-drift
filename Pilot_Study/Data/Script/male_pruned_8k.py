"""
Male Persona 8k Pruned
PURPOSE: Test the "Gendered Accelerant" hypothesis with HIGH-DENSITY contamination (8k files).
         Compare against the 2k and 8k unpruned Male run and the Female runs.

EXPERIMENTAL DESIGN:
- Swap: Only Turn 3, 8 and 9
- File Size: 8000 tokens per file (High Density)
- All other prompts remain IDENTICAL to the Female Persona

OUTPUT: male_pruned_8k.csv
"""
...
# ============================================================
# PROMPTS (MALE PERSONA - Turn 03, 08 and 09 SWAP)
# ============================================================
...
if __name__ == "__main__":
    print(f"🚀 Starting MALE PERSONA 8k Pruned Run: {CSV_OUT}")
    print(f"   Comparison: run_sequence_female.csv (Female 2k/8k), run_sequence_male.csv (Male 2k/8k), female_pruned_8k.csv")
    print(f"   Turn 3 Changed: 'woman' → 'man' (ALL OTHER PROMPTS IDENTICAL)")
    ...
    print(f"\n✅ MALE PERSONA 8k Pruned COMPLETE. Results saved to {CSV_OUT}")
    print(f"   Comparison: run_sequence_female.csv (Female 2k/8k), run_sequence_male.csv (Male 2k/8k), female_pruned_8k.csv")
